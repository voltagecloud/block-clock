...
| `isStopped`        | `boolean`                                                                                           | Toggle whether the Bitcoin Node is stopped and show the stopped state. Used when the node is offline or RPC is unreachable. Optional                                                                                                                                                                                                                                                                                                                             | `false`                                                                                                       | `false`                                                                                                       |
